...
EXCLUDE_DIRS = {".git", ".github", "dist", "__pycache__", ".venv", ".pytest_cache", "tests", "assets"}
...
def main() -> None:
    ...
    parser.add_argument("--version", default="1.0.0", help="version used in the zip filename")
